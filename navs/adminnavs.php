 ...
 <aside class="sidebar">
    ...
    <div class="sidebar-section">
      ...
      <a class="nav-item active" href="http://localhost/rent/layouts/admindashboard.php">
      ...
      <a class="nav-item" href="http://localhost/rent/layouts/adminbooking.php">
        <svg class="nav-icon" width="17" height="17" viewBox="0 0 17 17" fill="none" color="white">
    ...
    <div class="sidebar-section">
      ...
      <a class="nav-item" href="http://localhost/rent/layouts/adminvehicles.php">
        <svg class="nav-icon" width="17" height="17" viewBox="0 0 17 17" fill="none" color="white">
      ...
      <a class="nav-item" href="http://localhost/rent/layouts/admindrivers.php">
        <svg class="nav-icon" width="17" height="17" viewBox="0 0 17 17" fill="none" color="white">
    ...
    <div class="sidebar-section">
      ...
      <a class="nav-item" href="http://localhost/rent/layouts/admincustomers.php">
        <svg class="nav-icon" width="17" height="17" viewBox="0 0 17 17" fill="none" color="white">
      ...
      <a class="nav-item" href="http://localhost/rent/layouts/adminpayments.php">
        <svg class="nav-icon" width="17" height="17" viewBox="0 0 17 17" fill="none" color="white">
      ...
      <a class="nav-item" href="http://localhost/rent/layouts/adminreports.php">
        <svg class="nav-icon" width="17" height="17" viewBox="0 0 17 17" fill="none" color="white">
    ...
    <div class="sidebar-section">
      ...
      <a class="nav-item" href="http://localhost/rent/layouts/adminsettings.php">
        <svg class="nav-icon" width="17" height="17" viewBox="0 0 17 17" fill="none" color="white">
