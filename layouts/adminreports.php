...
<link rel="stylesheet" href="/rent/css/adminreports.css">
    ...
    <div class="content">
      ...
      <div class="page-header">
        ...
        <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap">
          <button type="button" id="exportPdfBtn" class="btn-ghost" onclick="exportReport()">
      ...
      <div class="kpi-strip">
        ...
        <div class="kpi-card k-blue">
          ...
          <div class="kpi-value k-blue" id="kpi-bookings">0</div>
          <div class="kpi-delta up" id="kpi-bookings-delta"></div>
        ...
        <div class="chart-card">
          <div class="chart-head">
            <div>
              ...
              <div class="chart-sub">Bookings by vehicle type</div>
            </div>
          </div>
          <div class="chart-body">
...
<script src="/rent/javascript/vendor/jspdf.umd.min.js"></script>
<script src="/rent/javascript/vendor/jspdf.plugin.autotable.min.js"></script>
<script src="/rent/javascript/theme.js"></script>
<script src="/rent/javascript/adminreports.js?v=2"></script>
